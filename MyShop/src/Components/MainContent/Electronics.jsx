  ...
  return (
    ...
    <>
      ...
      <ul className='flex gap-7 text-xs justify-center p-2 px-8 font-semibold'>
        ...
        <li> <NavLink className='border-b border-b-red-600' to='/electronics' >ELECTRONICS</NavLink> </li>

        <li> <NavLink to='/jewellery' >JEWELLERY</NavLink> </li>

        <li> <NavLink to='/manscloths' >MEN'S CLOTH</NavLink> </li>

        <li> <NavLink to='/womenscloths' >WOMEN'S CLOTH</NavLink> </li>
      ...
      <div className='p-1.5'>
        ...
        <div  className='grid grid-cols-2 sm:grid-cols-3 border-gray-300 border-1 rounded-md place-items-center p-2 gap-2 mt-7 md:gap-y-5 lg:grid-cols-4 2xl:grid-cols-6'>

          {data.filter((products) => products.category === 'electronics').map((products) => 
            ...
            <div key={products.id} className=' text-black'>
                ...
                <div className='flex flex-col border-gray-300 border-1 rounded-md items-center justify-between p-2 w-40 h-80 md:w-60'>
                    ...
                    <div className='text-xs p-1 flex flex-col gap-y-2'>
                        ...
                        <button onClick={() => addBtn(products)}
