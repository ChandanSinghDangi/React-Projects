  ...
  return (
    ...
    <>
      ...
      <ul className='flex gap-7 text-xs justify-center p-2 px-8 font-semibold'>
        ...
        <li> <NavLink  className='border-b border-b-red-600' to='/jewellery' >JEWELLERY</NavLink> </li>

        <li className=''> <NavLink to='/manscloths' >MEN'S CLOTH</NavLink> </li>

        <li className=''> <NavLink to='/womenscloths' >WOMEN'S CLOTH</NavLink> </li>
      ...
      <div className='p-1.5'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 sm:col-start-2 sm:col-span-1 border-gray-300 border-1 rounded-md place-items-center p-2 gap-2 mt-7 md:gap-y-5 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6'>

          {data.filter((products) => products.category === 'jewelery').map((products) => 
